...
@compile
def test_div_assign() -> f64:
    """Test /= operator (returns float per Python semantics)"""
    x: f64 = 20.0
    x /= 4.0
    return x  # 5.0
...
@compile
def test_floordiv_assign() -> i32:
    """Test //= operator (integer division)"""
    x: i32 = 20
    x //= 4
    return x  # 5
...
@compile
def test_precedence_div_sub() -> f64:
    """Test / has higher precedence than - (returns float)"""
    return 10.0 - 6.0 / 2.0  # 7.0


@compile
def test_precedence_floordiv_sub() -> i32:
    """Test // has higher precedence than -"""
...
class TestCompoundAssignment(unittest.TestCase):
    def test_arithmetic_compound(self):
        ...
        self.assertAlmostEqual(test_div_assign(), 5.0)
        self.assertEqual(test_floordiv_assign(), 5)
...
class TestPrecedence(unittest.TestCase):
    def test_basic_precedence(self):
        ...
        self.assertAlmostEqual(test_precedence_div_sub(), 7.0)
        self.assertEqual(test_precedence_floordiv_sub(), 7)
