...
_register(
    'enable_clang_cimport', 'PC_ENABLE_CLANG_CIMPORT', False, _to_bool,
    'Legacy switch: forces the clang cimport backend when truthy and '
    'no explicit backend is requested.',
    'Read on every cimport call.',
)
_register(
